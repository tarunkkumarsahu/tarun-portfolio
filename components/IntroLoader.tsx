        ...
        >
          ...
          <div className="entry-loader__stage">
            <div className="entry-loader__assembly" aria-hidden="true">
              <motion.i
                className="entry-loader__blade--a"
                initial={{ x: -90, y: 64, rotate: -18, opacity: 0 }}
                animate={{ x: 0, y: 0, rotate: -9, opacity: 1 }}
                transition={{ duration: 0.78, ease: [0.22, 1, 0.36, 1] }}
              />
              <motion.i
                className="entry-loader__blade--b"
                initial={{ x: 92, y: -50, rotate: 18, opacity: 0 }}
                animate={{ x: 0, y: 0, rotate: 7, opacity: 1 }}
                transition={{ delay: 0.05, duration: 0.82, ease: [0.22, 1, 0.36, 1] }}
              />
              <motion.i
                className="entry-loader__blade--c"
                initial={{ x: 0, y: -84, scaleX: 0.45, opacity: 0 }}
                animate={{ x: 0, y: 0, scaleX: 1, opacity: 1 }}
                transition={{ delay: 0.1, duration: 0.78, ease: [0.22, 1, 0.36, 1] }}
              />
              <motion.i
                className="entry-loader__blade--d"
                initial={{ y: 95, scaleY: 0.35, opacity: 0 }}
                animate={{ y: 0, scaleY: 1, opacity: 1 }}
                transition={{ delay: 0.16, duration: 0.74, ease: [0.22, 1, 0.36, 1] }}
              />
              <motion.span
                className="entry-loader__core"
                initial={{ opacity: 0, scale: 0.3, rotate: 0 }}
                animate={{ opacity: 1, scale: 1, rotate: 45 }}
                transition={{ delay: 0.48, duration: 0.52, ease: [0.22, 1, 0.36, 1] }}
              />
            </div>
          ...
          <div className="entry-loader__bottom">
            ...
            <motion.span
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 1.02, duration: 0.25 }}
            >
              READY
            </motion.span>
          </div>
